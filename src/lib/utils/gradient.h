...
template <typename T>
class PS_LIB_INLINE LinearGradient : public Gradient<T>
{
public:
...
template <typename T>
class PS_LIB_INLINE MultiLinearGradient : public Gradient<T>
{
private:
	struct Point
	{
...
class PS_LIB StandardGradient : public MultiLinearGradient<QVector4D>
{
public:
	enum Type
	{
